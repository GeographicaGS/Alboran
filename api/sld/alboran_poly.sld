...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Alboran Polygon</Name>
    <UserStyle>
        <!-- they have names, titles and abstracts -->

      <Title>Alboran default polygon style</Title>
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          ...
          <PolygonSymbolizer>
            <Fill>
              <CssParameter name="fill">#e89292</CssParameter>
            </Fill>
            <Stroke>
              <CssParameter name="stroke">#eee7e7</CssParameter>
